...
public class EnShoot : MonoBehaviour
{
    ...
    private EnemyComportement enemyComportement; // Référence au comportement de l'ennemi

    void Start()
    {
        playerTransform = GameObject.FindGameObjectWithTag("Player").transform;
        enemyComportement = GetComponent<EnemyComportement>(); // Obtenir le script EnemyComportement
    ...
    IEnumerator ShootAtPlayer()
    {
        while (isShooting)
        {
            ...
            // Initialisation du projectile avec les dégâts et le script de pool
            ...
            // Assurer que le projectile retourne dans le pool après sa durée de vie
